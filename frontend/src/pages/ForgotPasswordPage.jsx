...
function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || err.response?.data || 'Failed to send reset code. Please try again.';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-4 py-8">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl shadow-lg shadow-yellow-500/30 mb-4">
          ...
          {success ? (
            ...
            <div className="text-center">
              ...
              <p className="text-blue-200 mb-6">
                We've sent a password reset code to <span className="font-semibold text-white">{email}</span>
              </p>
              <Link
                to="/reset-password"
                state={{ email }}
                className="inline-flex items-center justify-center gap-2 w-full py-3 px-4 bg-gradient-to-r from-yellow-600 to-orange-600 text-white font-semibold rounded-xl shadow-lg hover:from-yellow-500 hover:to-orange-500 transition duration-200"
              >
                Enter Reset Code
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      autoComplete="email"
                      className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition duration-200"
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-gradient-to-r from-yellow-600 to-orange-600 text-white font-semibold rounded-xl shadow-lg shadow-yellow-500/30 hover:shadow-yellow-500/50 hover:from-yellow-500 hover:to-orange-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-transparent disabled:opacity-50 disabled:cursor-not-allowed transition duration-200 flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
